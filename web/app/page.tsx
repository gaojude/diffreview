...
export default function Home() {
  return (
    <main className="min-h-screen flex flex-col items-center px-4 py-16">
      ...
      <footer className="mt-24 text-[var(--color-text-dim)] text-xs opacity-60">
        MIT · built by{" "}
        <a href="https://github.com/gaojude" className="underline hover:text-white">
          gaojude
        </a>
      </footer>
    </main>
